    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    <label for="inputPassword" class="col-md-3 col-form-label">Product Stocks</label>
                    <div class="col-md-9">
                        <input type="text" class="form-control" id="product_stocks" spellcheck="false" autocomplete="false" placeholder="Product Stocks...">
                    </div>
                </div>
                <div class="form-group row">
