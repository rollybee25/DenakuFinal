...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="index3.html" class="brand-link">
    <img src="{{ asset('dist/img/AdminLTELogo.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
         style="opacity: .8">
    <span class="brand-text font-weight-light">Stallion</span>
  </a>
  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      ...
      <div class="info">
        <a href="#" class="d-block">Rolly Asuncion</a>
      </div>
    </div>
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
        ...
        <li class="nav-item">
          <a href="{{route('pos.view') }}" class="nav-link {{ (request()->is('pos')) ? 'active' : '' }}">
        ...
        <li class="nav-item">
          <a href="{{route('sales.view') }}" class="nav-link {{ (request()->is('sales')) ? 'active' : '' }}">
        ...
        <li class="nav-item">
          <a href="{{route('client.index') }}" class="nav-link {{ (request()->is('client')) ? 'active' : '' }}">
            <i class="nav-icon fas fas fa-solid fa-user"></i>
            <p>
              Customers
            </p>
          </a>
